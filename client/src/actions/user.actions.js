...
export const getUser = (uid) => {
	return (dispatch) => {
		return axios
			.get(`http://localhost:5001/api/user/uid/${uid}`)
			.then((res) => {
...
export const updateName = (userId, name) => {
	return (dispatch) => {
		return axios({
			method: "put",
			url: `http://localhost:5001/api/user/change_name/` + userId,
			data: { name },
		})
			.then((res) => {
...
export const updateFirstname = (userId, firstname) => {
	return (dispatch) => {
		return axios({
			method: "put",
			url: `http://localhost:5001/api/user/change_firstname/` + userId,
			data: { firstname },
		})
			.then((res) => {
...
export const updateMail = (userId, mail) => {
	return (dispatch) => {
		return axios({
			method: "put",
			url: `http://localhost:5001/api/user/change_mail/` + userId,
			data: { mail },
		})
			.then((res) => {
...
export const updateGender = (userId, gender) => {
	return (dispatch) => {
		return axios({
			method: "put",
			url: `http://localhost:5001/api/user/change_gender/` + userId,
			data: { gender },
		})
			.then((res) => {
...
export const updateOrientation = (userId, orientation) => {
	return (dispatch) => {
		return axios({
			method: "put",
			url: `http://localhost:5001/api/user/change_orientation/` + userId,
			data: { orientation },
		})
			.then((res) => {
...
export const pushLike = (likerUid, likedUid) => {
	return (dispatch) => {
		return axios({
			method: "post",
			url: `http://localhost:5001/api/user/like`,
