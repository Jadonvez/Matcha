		...
		<div className="testzuby">
			...
			<div className="research-container">
				<div className="box-research-bar">
					<div className="icone-research">
						<img
							className="research-image"
							src="./img/searching-a-person.svg"
							height="20"
							alt="img-search-logo"
						/>
					</div>
					<div className="research-bar">
						<input
							className="input-research-bar"
							type="search"
							placeholder="Recherche un hashtag ..."
						/>
					</div>
					<div className="button-research">
						<button className="real-button-research">Rechercher</button>
					</div>
				</div>
