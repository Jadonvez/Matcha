...
const updateMail = (req, res) => {
    ...
    pool.query("SELECT * FROM users WHERE id = $1", [id], (error, results) => {
        ...
        pool.query("UPDATE users SET mail = $1 WHERE id = $2", [mail, id], (error, results) => {
            if (error) throw error;
...
const updateGender = (req, res) => {
    ...
    pool.query("SELECT * FROM users WHERE id = $1", [id], (error, results) => {
        ...
        pool.query("UPDATE users SET gender = $1 WHERE id = $2", [gender, id], (error, results) => {
            if (error) throw error;
...
const updateOrientation = (req, res) => {
    ...
    pool.query("SELECT * FROM users WHERE id = $1", [id], (error, results) => {
        ...
        pool.query("UPDATE users SET orientation = $1 WHERE id = $2", [orientation, id], (error, results) => {
            if (error) throw error;
